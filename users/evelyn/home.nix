...
#      enable = true;
#      events = [
#        { event = "before-sleep"; command = "${pkgs.swaylock-effects}/bin/swaylock -f --screenshots --effect-blur 7x5"; }
#        { event = "lock"; command = "${pkgs.swaylock-effects}/bin/swaylock -f --screenshots --effect-blur 7x5"; }
#      ];
#    };
